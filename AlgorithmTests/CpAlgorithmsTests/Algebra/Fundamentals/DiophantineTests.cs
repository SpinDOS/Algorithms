...
namespace AlgorithmTests.CpAlgorithmsTests.Algebra.Fundamentals
{
    public class DiophantineTests
    {
        ...
        private void CheckSolvable(long a, long b, long c, bool solvable)
        {
            ...
            ClassicAssert.AreEqual(solvable, DiophantineSolver.TrySolve(a, b, c, out var x, out var y, out _), equation);
            if (solvable)
                ClassicAssert.AreEqual(c, a * x + b * y, equation);
        }
            ...
            ulong solutionCount)
        {
            ...
            ClassicAssert.AreEqual(solutionCount, DiophantineSolver.FindSolutionsCount(a, b, c, intervalX, intervalY), equation);
        }
    }
}
